    ...
    <div class="col-xs-12">
        ...
        <table class="table table-responsive table-bordered table-condensed">
            ...
            <tbody>
                @forelse($receipt_details->lines as $line)
                    <tr>
                        ...
                        <th class="text-right">{{ $line['quantity'] }} {{ $line['units'] }} </th>
                        {{-- <th></th> --}}
            ...
            <tr>
                ...
                <td class="text-right"><b> {{ $receipt_details->subtotal }}</b></td>
            </tr>
            <tr>
                <td colspan="4" rowspan="9"><b>Company's Bank Details</b>
                    <ul class="list-unstyled">
                        <li class="price-detail">
                        ...
                        <li class="price-detail">
                            <div class="detail-title">Pan Card No.: </div>
                            <div class="detail-amt" style="margin-right:80px;">
            ...
            <tr>
                <td>CGST(1.5%)</td>
                <th> (+) {{ $receipt_details->tax_cgst_sgst / 2 }}</th>
            </tr>
            <tr>
                <td>SGST(1.5%)</td>
                <th> (+) {{ $receipt_details->tax_cgst_sgst / 2 }}</th>
            ...
            <tr>
                ...
                <td style="width:16%;text-align:center;"><b>Customer Signatur</b></td>
