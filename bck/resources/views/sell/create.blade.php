                    ...
                    <div class="@if (!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="hidden" id="default_customer_custom_field1"
                                    value="{{ $walk_in_customer['custom_field1'] }}">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <div class="multi-input">
                                ...
                                {!! Form::select('pay_term_type', ['months' => __('lang_v1.months'), 'days' => __('lang_v1.days')], $walk_in_customer['pay_term_type'], ['class' => 'form-control width-60 pull-left', 'placeholder' => __('messages.please_select'), 'required' => $is_pay_term_required]) !!}
                            </div>
                        </div>
                    </div>
