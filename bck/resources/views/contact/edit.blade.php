         ...
         <div class="col-sm-4">
            <div class="form-group individual">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('anniversary_date', !empty($contact->anniversary_date) ? @format_date($contact->anniversary_date) : null, ['class' => 'form-control dob-date-picker','placeholder' => __('lang_v1.anniversary_date'), 'readonly']); !!}
                </div>
            </div>
        </div>
