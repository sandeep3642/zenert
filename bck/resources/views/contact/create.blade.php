    ...
    <div class="modal-body">
        <div class="row">            
            ...
            <div class="col-sm-4 individual" style="display: none;">
             ...
             <div class="col-sm-4 individual" style="display: none;">
                <div class="form-group">
                    {!! Form::label('anniversary_date', __('lang_v1.anniversary_date') . ':') !!}
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                        </span>
                        
                        {!! Form::text('anniversary_date', null, ['class' => 'form-control dob-date-picker','placeholder' => __('lang_v1.anniversary_date'), 'readonly']); !!}
                    </div>
                </div>
            </div>
            <div class="col-sm-4 business" style="display: none;">
                <div class="form-group">
                    {!! Form::label('dob', __('lang_v1.dob') . ':') !!}
                    <div class="input-group">
                        <span class="input-group-addon">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::text('city', 'Dehradun', ['class' => 'form-control', 'placeholder' => __('business.city')]); !!}
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <span class="input-group-addon">
                        ...
                        {!! Form::text('state', 'Uttrakhand', ['class' => 'form-control', 'placeholder' => __('business.state')]); !!}
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <span class="input-group-addon">
                        ...
                        {!! Form::text('country', 'India', ['class' => 'form-control', 'placeholder' => __('business.country')]); !!}
                    </div>
                </div>
            </div>
            <div class="col-md-3">
